...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      const notificationMessage = `[ALIENX JOURNAL] ${directionEmoji} ${trade.direction} Entered: ${trade.asset} @ ${trade.entryPrice} | SL: ${trade.stopLoss} | TP1: ${trade.tp1} | Checklist: ${trade.checklistScore}/13`;
